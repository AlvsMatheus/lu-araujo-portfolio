    ...
    >
      <div className="flex flex-col justify-center items-center gap-25 md:gap-5 lg:gap-30">
        <div className="flex justify-between items-center w-full px-5 py-5 gap-4 md:px-20 md:py-8">
          ...
          <div className="relative flex flex-col justify-center gap-4 item-start md:items-end">
            ...
            <span className="relative z-10 flex justify-center items-center text-[10px] lg:text-[12px] bg-[#923e3e] rounded-full text-white px-3 lg:px-5 py-4 lg:py-4">
